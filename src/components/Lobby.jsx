    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col gap-6 sm:gap-8">
      ...
      {!showSetup ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full items-stretch animate-in fade-in zoom-in duration-300">
            {/* Left Column: Player Identity */}
            <div className="lg:col-span-5 glass-black p-6 sm:p-7 space-y-6 flex flex-col justify-between">
              <div className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    maxLength={14}
                    className="w-full bg-black border-2 border-slate-800 focus:border-slate-500 rounded-xl px-4 py-2.5 text-slate-100 font-bold text-sm focus:outline-none transition-all shadow-inner"
                  />
                </div>
            ...
            <div className="lg:col-span-7 glass-black-highlight p-6 sm:p-7 flex flex-col justify-between space-y-6">
              <div className="space-y-5">
                <div className="flex items-center gap-3 border-b border-slate-800 pb-3">
                  <div className="w-9 h-9 rounded-xl bg-slate-900 border border-slate-700 flex items-center justify-center">
                ...
                <div className="flex flex-col items-center justify-center space-y-8 py-2">
                  <div className="text-center space-y-4">
                    ...
                    <div 
                      ...
                      className={`mx-auto mt-6 w-32 h-14 rounded-full bg-gradient-to-b from-[#2A2A2A] to-[#1A1A1A] border border-slate-700 cursor-pointer shadow-[inset_0_4px_8px_rgba(0,0,0,0.6)] flex items-center p-1.5 transition-all ${
                  ...
                  <div className="w-full bg-white rounded-[24px] p-6 sm:p-8 shadow-xl transition-all duration-300 relative overflow-hidden group border border-slate-200">
                ...
                <button
                  ...
                  className="w-full btn-black-primary text-xs sm:text-sm py-3.5 rounded-xl shadow-lg"
                >
              ...
              <div className="border-t border-slate-800 pt-4 space-y-2">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <input
                    ...
                    maxLength={10}
                    className="flex-1 bg-black border-2 border-slate-800 focus:border-slate-500 rounded-xl px-4 py-2.5 text-xs font-mono text-slate-100 uppercase tracking-widest focus:outline-none"
                  />
                  <button
                    onClick={() => handleJoin()}
                    disabled={!roomCodeInput.trim()}
                    className="btn-black-accent text-xs px-5 py-2.5 rounded-xl"
                  >
          ...
          <div className="glass-black p-5 sm:p-6 space-y-4 w-full animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
            ...
            {lanRooms.length === 0 ? (
              <div className="p-4 rounded-xl bg-black border border-slate-800 text-center text-xs text-slate-400 font-medium">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                {lanRooms.map((room) => (
                  <div
                    ...
                    className="p-3.5 rounded-xl bg-black border border-slate-700 hover:border-slate-500 transition-all cursor-pointer flex items-center justify-between group shadow-md"
                  >
                    <div>
