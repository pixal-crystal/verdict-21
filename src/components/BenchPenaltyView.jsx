...
export function BenchPenaltyView({ roundsLeft, player }) {
  return (
    <div className="w-full max-w-xl mx-auto my-10 p-10 sm:p-14 glass-black-highlight text-center space-y-10 border border-slate-700/80 shadow-2xl">
      {/* Warning Badge */}
      ...
      <div className="p-10 sm:p-12 rounded-2xl bg-black/80 border border-slate-800 flex flex-col items-center justify-center space-y-5 relative z-10 shadow-xl">
